...
export const paris = {
    ...
    first_img_alt: 'living_in_paris alt',
    grid_images: ['paris_grid_1', 'paris_grid_2', 'paris_grid_3', 'paris_grid_4'],
    grid_img_alt: ['paris_grid_1', 'paris_grid_2', 'paris_grid_3', 'paris_grid_4'],
    map: 'cnWCUN529qw38Yce6',
    map_text:
        'Deriv (France) is going to be our research and development branch. We’re going to create an elite think tank in this office that will help create our next generation of online trading products. If you’re looking for new fintech challenges to embrace, join our team in Paris.',
...
export const london = {
    ...
    display_name: 'London',
    img_alt: 'London alt img',
    map_office_name: '(UK)',
    country: 'United Kingdom',
    flagIcon: UKFlagIcon,
    thumbnail: 'thumbnail_london',
    first_p:
        'We’re looking for experts in law, finance, and risk management to work together in our London office as a senior team of strategists. This office will have three crucial functions: ensuring regulatory and statutory compliance in all areas of company operations within the UK jurisdiction, making financial plans to support company growth, and mitigating risks.',
    first_img: 'living_in_london',
    first_img_alt: 'living_in_london alt img',
    grid_images: ['london_grid_1', 'london_grid_2', 'london_grid_3', 'london_grid_4'],
    grid_img_alt: ['london_grid_1', 'london_grid_2', 'london_grid_3', 'london_grid_4'],
